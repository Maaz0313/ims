                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control @error('image') is-invalid @enderror" id="image"
                                name="image">
                            <small class="text-muted">Leave empty to keep the current image. Supported formats: JPEG, PNG,
                                JPG, GIF, WebP. Max size: 2MB.</small>
                            @error('image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0"
                                ...
                                name="quantity" value="{{ old('quantity', $product->inventory->quantity ?? 0) }}"
                                required>
                            @error('quantity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0"
                                ...
                                name="reorder_level"
                                value="{{ old('reorder_level', $product->inventory->reorder_level ?? 10) }}" required>
